...
export default function MusicCard({id,title,description,image,singer,date_released}:MusicProps) {
  return (
  ...
  <div className="card-body">
    <span className="fw-bold fs-5" style={{display: "block"}}>{title}</span>
    <span className="card-text" id="collapseContent">
      {description}
    </span>
    <div className="d-flex justify-content-end">
      <a className="btn btn-link link-success p-md-1 my-1"  href={"/"+title}
